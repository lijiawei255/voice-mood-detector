...
界面设计采用**苏联构成主义风格**（Soviet Constructivist）：粗炭黑边框、砖红点缀(#C44B4F)、45°斜线纹理、三角楔形装饰、纯几何无圆角、工业感暖白基底(#F2EDE4)、不对称卡片布局。
...
| 📡 声学特征提取 | F0、jitter、shimmer、HNR、MFCC 等临床级语音特征 (P1) |
| 🔬 科研评估模式 | 双模型交叉验证、多次采样综合评估、ICC 信度评估 (P1) |
| 📤 研究数据导出 | CSV (SPSS/Excel兼容) 和 JSON 完整研究数据集导出 (P1) |
